"""Private tests for string_utils — used for terminal reward / checkpoint selection."""

from src.string_utils import capitalize_words, count_substring, pad_string, reverse_words, truncate_string


class TestTruncateStringPrivate:
    def test_unicode_truncation(self):
        result = truncate_string("café", 4)
        assert result == "café"
